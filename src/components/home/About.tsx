            ...
            <div className="text-neutral-700 dark:text-neutral-600 leading-relaxed">
                <ReactMarkdown
                    ...
                    components={{
                        ...
                        h2: ({ children }) => <h2 className="text-2xl font-serif font-bold tracking-tight text-primary mt-8 first:mt-0 mb-4 border-b border-neutral-200 dark:border-neutral-800 pb-2">{children}</h2>,
