...
export default function HomePageClient({ dataByLocale, defaultLocale }: HomePageClientProps) {
  ...
  return (
    <div className="acad-page-shell max-w-[1280px] mx-auto px-2 sm:px-3 lg:px-2 py-4 bg-background min-h-screen">
      <div className="grid grid-cols-1 lg:grid-cols-[15rem_minmax(0,1fr)] gap-4 lg:gap-4">
        <div className="lg:col-span-1">
          <div className="acad-sidebar-card bg-white dark:bg-neutral-800/50 rounded-2xl shadow-lg p-4 backdrop-blur-sm border border-neutral-200/50 dark:border-neutral-700/50">
            <Profile
              author={data.author}
              social={data.social}
