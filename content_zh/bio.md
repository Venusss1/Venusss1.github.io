<div class="homepage-sections acad-homepage">
  ...
  <section class="home-section" id="education">
    ...
    <div class="edu-list">
      <article class="edu-item">
        ...
        <div class="edu-item__date">2023 至今</div>
      </article>
    </div>
  </section>

  <section class="home-section" id="scores">
    <h2 class="home-section__title">📝 成绩表现</h2>
    <div class="kv-list score-list">
      <div class="kv-item"><div class="kv-item__main"><strong>绩点：</strong><span class="top-rank">3.69/4.0</span></div></div>
  ...
  <section class="home-section" id="internships">
    <h2 class="home-section__title">💻 科研实习</h2>
    <div class="intern-list">
      <article class="intern-entry">
        ...
        <div class="intern-item__notes">围绕智能体数据合成、多模态深度搜索、SFT / RL 后训练和过程评测开展研究。</div>
      </article>
      <article class="intern-entry">
        <div class="intern-item">
        ...
        <div class="intern-item__notes">关注晶圆缺陷检测、故障预测健康管理、持续学习和类增量方法。</div>
      </article>
      <article class="intern-entry">
        <div class="intern-item">
        ...
        <div class="intern-item__notes">参与相关方向调研和复现，补充视觉生成模型相关训练。</div>
      </article>
    </div>
  </section>
